...
subtest 'get_assembly' => sub{
    ...
    my $expected_url = '/data/my-assembly';
    my $expected_assembly = Tenx::Assembly->create(url => $expected_url);
    ...
    lives_ok(sub{ $assembly = $test{class}->get_assembly('/data/assembly2'); }, 'get non existing aassembly by url');
